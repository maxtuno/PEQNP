...
OPTION( stable_ahead,      0,  0,  1000,  0,  "Look ahead value for stable-allUIP")\
OPTION( stable_allUIP,      1,  0,  1,  0,  "enable stable-allUIP")\
OPTION( stable_allUIP_active,      0,  0,  1,  0,  "enable stable-allUIP-active")\
OPTION( stable_allUIP_exclusive,      0,  0,  1,  0,  "enable stable-allUIP-exclusive")\
OPTION( stable_allUIP_hybrid,      0,  0,  1,  0,  "enable stable-allUIP-hybrid")\
OPTION( stable_allUIP_pure,      0,  0,  1,  0,  "enable stable-allUIP-pure")\
OPTION( stable_minimize_limit,      50,  0,  2e9,  0,  "limit for minimize stable_allUIP clause")\
